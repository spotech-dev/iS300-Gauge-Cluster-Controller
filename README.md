...
**Given the current state of the PCB, do NOT connect both the 12v barrel jack and the USB-C port at once. Only use one or the other at any given time until I find a workaround!**
